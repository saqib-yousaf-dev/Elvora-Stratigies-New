    ...
    <div className="min-h-screen" style={{ background: "#f8fbff" }}>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            AI Chatbot <br />
            <span style={{ color: "#F5A623" }}>Receptionist</span>
          </h1>
          <p className="text-white/90 text-xl max-w-2xl mx-auto leading-relaxed mb-10">
            Think of Pulse as your most capable receptionist. It answers
            relevant questions, understands the enquiry, and hands over the
            details that matter.
          </p>
          <button
            onClick={openChatbot}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
              We build custom AI assistants that hold genuine consultative
              conversations, delivering a premium experience for every single
              visitor.
            </p>
          </div>
      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/90 mb-12 text-lg font-medium">
            Your bespoke AI receptionist can be live and qualifying leads in
            under 14 days.
          </p>
