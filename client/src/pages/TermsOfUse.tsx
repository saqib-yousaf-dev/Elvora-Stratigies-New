      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 text-xs font-bold tracking-widest uppercase rounded-full bg-white/10 backdrop-blur-md border border-white/20">
            <FileText size={14} className="text-amber-400" /> Agency Terms &amp;
            Conditions
          </div>
          <h1
          ...
          <p className="text-white/80 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
            Please read these terms carefully before engaging with Elvora
            Strategies and our AI receptionist services.
          </p>
        ...
        >
          <section>
            ...
            <p className="leading-relaxed">
              By accessing elvorastrategies.com or subscribing to our AI
              receptionist services ("Pulse"), you agree to be bound by these
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              Elvora Strategies provides custom AI-powered chatbot receptionists
              billed on monthly or annual subscription tiers (Starter,
              Professional, Growth, and Custom).
            </p>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              All content, brand assets, software architecture, code frameworks,
              and proprietary AI conversational flows on this website are the
              intellectual property of ELVORASTRATEGIES LTD. Unauthorised
              reproduction or commercial redistribution is strictly prohibited.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              While our AI receptionists are engineered for high accuracy and
              uptime, Elvora Strategies shall not be held liable for indirect,
              incidental, or consequential damages resulting from missed leads,
              third-party API downtime (such as hosting or LLM providers), or
              miscommunications handled by automated assistant interactions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              laws of England and Wales. Any disputes relating to these terms
