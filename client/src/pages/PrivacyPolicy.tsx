import { ArrowLeft, Shield, Mail, Linkedin, Phone, CheckCircle } from "lucide-react";
    ...
    <div style={{ background: "#f8fbff", minHeight: "100vh" }}>
      ...
      <section className="relative py-24 px-6 lg:px-10 overflow-hidden text-center text-white" style={{ background: "linear-gradient(135deg, #1e3a5f 0%, #0369a1 50%, #0284c7 100%)" }}>
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 text-xs font-bold tracking-widest uppercase rounded-full bg-white/10 backdrop-blur-md border border-white/20">
            <Shield size={14} className="text-amber-400" /> UK GDPR Compliant Governance
          </div>
          ...
          <p className="text-white/80 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
            Transparency is core to how we operate. Read how we protect and manage personal data across our systems.
          </p>
        ...
        <div className="bg-white p-10 lg:p-14 rounded-[2.5rem] border shadow-xl shadow-sky-900/5 space-y-12 text-gray-700" style={{ borderColor: "#e0f2fe" }}>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ELVORASTRATEGIES LTD is an AI automation agency based in Manchester, UK. We build bespoke AI chatbot receptionists for businesses. Our registered office is First Floor, Swan Buildings, 20 Swan Street, Manchester, M4 5JW. You can contact us at <a href="mailto:info@elvorastrategies.com" className="font-semibold underline text-sky-600">info@elvorastrategies.com</a> or <a href="tel:+441615150022" className="font-semibold underline text-sky-600">01615 150022</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4 leading-relaxed">We collect data in two distinct contexts:</p>
            <div className="space-y-4">
              <div className="p-5 bg-slate-50 border rounded-2xl" style={{ borderColor: "#e0f2fe" }}>
                <p className="font-bold text-gray-900 mb-1">a) Website visitors (elvorastrategies.com)</p>
                <p className="text-sm text-gray-600">If you contact us via our chatbot, email, or WhatsApp, we may collect your name, email address, phone number, and the content of your enquiry.</p>
              </div>
              <div className="p-5 bg-slate-50 border rounded-2xl" style={{ borderColor: "#e0f2fe" }}>
                <p className="font-bold text-gray-900 mb-1">b) End users of our clients' Pulse AI receptionists</p>
                <p className="text-sm text-gray-600">When a visitor interacts with a Pulse AI receptionist deployed on a client's website, we collect information on behalf of that client. This includes contact details, enquiry summaries, and conversation transcripts.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 font-semibold text-gray-900">We do not sell your data or use it for third-party advertising.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4 leading-relaxed">We process personal data under the following lawful bases:</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 border rounded-xl bg-sky-50/40" style={{ borderColor: "#bae6fd" }}>
                <p className="font-bold text-sky-900 mb-1 text-sm">Legitimate Interests</p>
                <p className="text-xs text-slate-600">To deliver lead capture services to our clients.</p>
              </div>
              <div className="p-4 border rounded-xl bg-sky-50/40" style={{ borderColor: "#bae6fd" }}>
                <p className="font-bold text-sky-900 mb-1 text-sm">Contractual Necessity</p>
                <p className="text-xs text-slate-600">To fulfil service agreements with clients.</p>
              </div>
              <div className="p-4 border rounded-xl bg-sky-50/40" style={{ borderColor: "#bae6fd" }}>
                <p className="font-bold text-sky-900 mb-1 text-sm">Consent</p>
                <p className="text-xs text-slate-600">Where visitors interact with an active Pulse AI assistant.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed mb-4">
              Lead data is retained as long as required to fulfil service agreements. Daily automated backups are kept on a 14-day rolling retention cycle. 
            </p>
            <p className="leading-relaxed">
              We employ strict technical measures including HTTPS/SSL encryption in transit, encryption at rest for sensitive lead fields, and firewall-protected private servers. For full details, visit our <Link href="/data-security"><span className="text-sky-600 underline font-semibold cursor-pointer">Data &amp; Security page</span></Link>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3 leading-relaxed">Under UK GDPR, you hold rights to access, correct, erase, or restrict processing of your personal data, as well as lodge complaints with the ICO (ico.org.uk).</p>
            <p className="leading-relaxed">To exercise any rights, reach out directly at <a href="mailto:info@elvorastrategies.com" className="font-semibold underline text-sky-600">info@elvorastrategies.com</a>.</p>
          </section>
      ...
      <section className="relative py-20 px-6 lg:px-10 overflow-hidden text-center text-white" style={{ background: "#1e3a5f" }}>
        <div className="max-w-2xl mx-auto">
          <span className="text-xs font-bold tracking-widest uppercase mb-3 block text-amber-400">Compliant Infrastructure</span>
