...
const FEATURES = [
  {
    ...
    desc: "Includes all Growth features: advanced qualification flows, dedicated onboarding support, quarterly strategy reviews, and priority support.",
  },
  {
    title: "Unlimited Conversations",
    desc: "No monthly cap. Pulse handles every visitor interaction — however many arrive — without any overage charges.",
  },
  {
    title: "Multi-Location Deployment",
    desc: "Deploy Pulse across multiple websites, offices, or brands from a single account. Each location gets its own trained assistant.",
  },
  {
    title: "Custom Integrations & Workflows",
    desc: "We build bespoke integrations with your existing systems — your CRM, your practice management software, your internal tools. If it has an API, we can connect it.",
  },
  {
    title: "Dedicated Account Manager",
    desc: "A named account manager who knows your business, monitors your performance, and proactively suggests improvements — not a support ticket queue.",
  },
  {
    title: "SLA-Backed Support",
    desc: "Formal service level agreement with guaranteed response and resolution times. Enterprise-grade reliability for businesses that can't afford downtime.",
  },
];
...
const USE_CASES = [
  {
    ...
    desc: "Law firms, estate agencies, or care home groups with multiple locations — each site gets its own trained Pulse assistant.",
  },
  {
    icon: Globe,
    title: "Complex Integrations",
    desc: "Businesses with bespoke CRM systems, practice management software, or internal workflows that need custom API connections.",
  },
  {
    icon: Zap,
    title: "High-Volume Practices",
    desc: "Firms receiving hundreds of enquiries per week who need unlimited capacity and dedicated performance management.",
  },
  {
    icon: Shield,
    title: "Regulated Industries",
    desc: "Highly regulated sectors (financial services, legal, healthcare) requiring bespoke compliance flows and data handling agreements.",
  },
];
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1
            className="text-5xl lg:text-7xl font-bold text-white mb-4 tracking-tight drop-shadow-sm"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            Built Around <span style={{ color: "#F5A623" }}>Your Business</span>
          </h1>
          <p className="text-white/80 text-lg mb-6 font-medium">
            Pricing tailored to your exact requirements
          </p>
          <p className="text-white/90 text-xl max-w-2xl mx-auto leading-relaxed mb-10">
            For businesses that need more than a standard plan — unlimited
            conversations, multi-location deployment, custom integrations, and a
      ...
      <section className="py-28 px-6 lg:px-10 relative">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Everything in the{" "}
              <span className="text-sky-600">Custom Plan</span>
            </h2>
          </div>
            ...
            {FEATURES.map(f => (
              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3
                      className="font-bold text-gray-900 mb-3 text-xl tracking-tight transition-colors duration-300 group-hover:text-amber-600"
                      style={{ fontFamily: "'Playfair Display', serif" }}
                    >
                      {f.title}
                    </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {USE_CASES.map(uc => {
              ...
              return (
                <div
                  key={uc.title}
                  className="group p-8 border bg-slate-50 rounded-[2rem] transition-all duration-300 hover:bg-sky-50 hover:border-sky-200 hover:shadow-md"
                  style={{
      ...
      >
        <div className="relative max-w-2xl mx-auto text-center">
          <span className="text-xs font-bold tracking-widest uppercase mb-4 block text-amber-400">
          ...
          <p className="text-white/80 mb-10 text-lg font-medium">
            Tell us what you need and we'll have a tailored proposal to you
            within 48 hours.
          </p>
          <button
            onClick={openChatbot}
