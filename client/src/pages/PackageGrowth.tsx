      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/80 text-lg mb-6 font-medium">
            or <strong className="text-white">£2,149 / year</strong> — save 10%
          </p>
          <p className="text-white/90 text-xl max-w-2xl mx-auto leading-relaxed mb-10">
            For growing firms handling higher enquiry volumes — advanced
            qualification, dedicated onboarding, and quarterly strategic
            reviews.
          </p>
          <button
            onClick={openChatbot}
      ...
      <section className="py-28 px-6 lg:px-10 relative">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Everything in the{" "}
              <span className="text-sky-600">Growth Plan</span>
            </h2>
          </div>
      ...
      >
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/90 mb-10 text-lg font-medium">
            Equip your practice with advanced qualification flows and dedicated
            support.
          </p>
          <button
            onClick={openChatbot}
