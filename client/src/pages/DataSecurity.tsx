...
const PROTECTION_POINTS = [
  {
    ...
    desc: "HTTPS/SSL between website visitors, our dedicated server, and lead notification emails.",
  },
  {
    title: "Encrypted at rest",
    desc: "Sensitive lead fields (name, email, phone) are securely encrypted within our database.",
  },
  {
    title: "Restricted database access",
    desc: "A dedicated, limited-permission database user profile — never open to public administrative privileges.",
  },
  {
    title: "Firewall-protected server",
    desc: "Only essential ports are open; the core database is completely isolated from outside access.",
  },
  {
    title: "Hashed login credentials",
    desc: "Passwords are heavily scrambled and securely hashed, never stored as readable text.",
  },
  {
    title: "Daily automated backups",
    desc: "14-day rolling retention configured so data is fully protected against accidental loss.",
  },
  {
    title: "24/7 automated monitoring",
    desc: "Real-time system alerts are triggered instantly if any performance anomaly occurs.",
  },
];
  ...
  return (
    <div style={{ background: "#f8fbff", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 text-xs font-bold tracking-widest uppercase rounded-full bg-white/10 backdrop-blur-md border border-white/20">
            <Shield size={14} className="text-amber-400" /> Bank-Grade Security
            Standards
          </div>
          <h1
          ...
          <p className="text-white/80 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
            ...
            how we protect it, and what rigorous safeguards are in place.
          </p>
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-10 py-20">
        ...
        <section
          className="bg-white p-10 lg:p-14 rounded-[2.5rem] border shadow-xl shadow-sky-900/5 mb-16 relative overflow-hidden"
          style={{ borderColor: "#e0f2fe" }}
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-600 text-base leading-relaxed mb-8">
              When a visitor interacts with Pulse on your website, we collect
              the information needed to deliver a qualified lead to your
              business. The exact data captured is configured per client and may
              vary depending on your industry, workflow, and requirements. This
              typically includes:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              {[
                ...
                <div
                  key={index}
                  className="flex items-start gap-3 p-4 bg-slate-50 border rounded-2xl"
                  style={{ borderColor: "#e0f2fe" }}
                >
                  <CheckCircle
                    size={18}
                    className="flex-shrink-0 mt-0.5 text-sky-500"
                  />
            ...
            <div
              className="p-5 rounded-2xl border flex items-center gap-4 bg-sky-50/50"
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {PROTECTION_POINTS.map((item, i) => (
              <div
                key={i}
                className="bg-white p-8 border rounded-3xl shadow-sm hover:shadow-md transition-all group"
                style={{
        ...
        <section
          className="bg-white p-10 lg:p-14 rounded-[2.5rem] border shadow-xl shadow-sky-900/5 mb-16"
          style={{ borderColor: "#e0f2fe" }}
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            {[
              ...
              <div
                key={idx}
                className="p-5 border bg-slate-50 rounded-2xl flex items-start gap-3"
                style={{ borderColor: "#e0f2fe" }}
              >
                <CheckCircle
                  size={18}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div
            ...
            style={{ borderLeft: "4px solid #F5A623", borderColor: "#e0f2fe" }}
          >
            <h3
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Elvora Strategies is fully backed by Professional Indemnity
              Insurance, Cyber &amp; Data Insurance, and Legal Protection
              Insurance.
            </p>
          </div>
          <div
            className="bg-white p-8 border rounded-3xl shadow-sm"
            style={{ borderLeft: "4px solid #0ea5e9", borderColor: "#e0f2fe" }}
          >
            <h3
              className="text-2xl font-bold text-gray-900 mb-3"
              style={{ fontFamily: "'Playfair Display', serif" }}
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Data is never shared between clients, and deletion or data access
        ...
        <section className="bg-gradient-to-r from-sky-500 to-sky-700 text-white p-10 lg:p-14 rounded-[2.5rem] text-center shadow-xl">
          ...
          <p className="text-white/90 max-w-xl mx-auto mb-8 text-base">
            To request data deletion, access your records, or ask any
            security-related question, contact our compliance team directly.
          </p>
          <a
            href="mailto:info@elvorastrategies.com"
            className="inline-block font-bold text-sm px-8 py-4 rounded-xl shadow-lg transition-transform hover:scale-105"
