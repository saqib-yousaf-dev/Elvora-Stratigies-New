...
import { CheckCircle, ArrowLeft, MessageSquare, Database, ArrowRightLeft, LayoutDashboard, Share2, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen" style={{ background: "#f8fbff" }}>
      ...
      <section className="relative py-24 px-6 lg:px-10 overflow-hidden" style={{ background: "linear-gradient(135deg, #0ea5e9 0%, #38bdf8 50%, #7dd3fc 100%)" }}>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-sm" style={{ fontFamily: "'Playfair Display', serif" }}>
            CRM &amp; Inbox <br/><span style={{ color: "#F5A623" }}>Integration</span>
          </h1>
          <p className="text-white/90 text-xl max-w-2xl mx-auto leading-relaxed mb-10">
            Every conversation flows directly into your existing systems — fully formatted, tagged by enquiry type, and ready to act on.
          </p>
          <button onClick={openChatbot} className="group relative inline-flex items-center justify-center gap-2 font-bold text-sm px-8 py-4 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(245,166,35,0.4)] overflow-hidden rounded-sm" style={{ background: "#F5A623", color: "#1a1a1a" }}>
            ...
            <span className="relative flex items-center gap-2">
              <Share2 size={18} className="transition-transform duration-300 group-hover:rotate-12" /> See Pulse in Action
            </span>
          </button>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
              No chasing. <span className="relative inline-block">No data entry.<span className="absolute -bottom-1 left-0 right-0 h-1 bg-amber-400 opacity-60 rounded-full" /></span>
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
              We connect your custom AI assistant directly to the tools your team already uses, ensuring a frictionless handover from bot to human.
            </p>
          </div>
      ...
      <section className="relative py-28 px-6 lg:px-10 overflow-hidden" style={{ background: "#0ea5e9" }}>
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          <span className="text-xs font-bold tracking-widest uppercase mb-5 block text-sky-200">Connect Your Systems</span>
          ...
          <p className="text-white/90 mb-12 text-lg font-medium">Pulse connects with the tools you already rely on, ensuring no lead falls through the cracks.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-5">
            ...
            >
              <MessageSquare size={18} className="transition-transform duration-300 group-hover:-translate-y-1" /> Ask Pulse About Integrations
            </button>
            <Link href="/#pricing">
