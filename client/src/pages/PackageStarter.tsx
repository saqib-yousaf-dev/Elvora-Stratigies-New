      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/80 text-lg mb-6 font-medium">
            or <strong className="text-white">£1,069 / year</strong> — save 10%
          </p>
          <p className="text-white/90 text-xl max-w-2xl mx-auto leading-relaxed mb-10">
            Perfect for solo practitioners and small offices ready to capture
            every enquiry, 24 hours a day with zero friction.
          </p>
          <button
            onClick={openChatbot}
      ...
      <section className="py-28 px-6 lg:px-10 relative">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              Everything in the{" "}
              <span className="text-sky-600">Starter Plan</span>
            </h2>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gray-600 mb-3 text-base font-medium">
            Need CRM syncing, appointment booking, or higher volume?
          </p>
      ...
      >
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/90 mb-10 text-lg font-medium">
            Your bespoke AI receptionist can be live and answering visitors in
            under 2 weeks.
          </p>
          <button
            onClick={openChatbot}
