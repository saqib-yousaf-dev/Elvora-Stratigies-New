    ...
    <div className="min-h-screen" style={{ background: "#f8fbff" }}>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            Automated <br />
            <span style={{ color: "#F5A623" }}>Appointment Booking</span>
          </h1>
          <p className="text-white/90 text-xl max-w-2xl mx-auto leading-relaxed mb-10">
            Convert ad traffic directly into booked meetings. Pulse connects to
            your calendar and schedules qualified prospects in real time.
          </p>
          <button
            onClick={openChatbot}
          ...
          <div className="text-center mb-20">
            ...
            >
              ...
              <span className="relative inline-block text-sky-600">
                intent is high.
                <span className="absolute -bottom-1 left-0 right-0 h-1 bg-sky-400 opacity-60 rounded-full" />
              </span>
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
              When you pay to acquire a visitor, a static contact form isn't
              enough. Pulse secures the meeting before they have a chance to
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {FEATURES.map(f => {
              ...
              return (
                <div
                  key={f.title}
                  className="group bg-white p-8 border rounded-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(14,165,233,0.15)] cursor-default"
                  style={{
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    >
                      <Icon
                        size={26}
                        style={{ color: "#0284c7" }}
                        className="transition-colors duration-300 group-hover:text-sky-700"
                      />
                    </div>
                    <div>
                      <h3 className="font-bold text-gray-900 mb-3 text-xl tracking-tight transition-colors duration-300 group-hover:text-sky-600">
                        {f.title}
                      </h3>
      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/90 mb-12 text-lg font-medium">
            Let Pulse handle your scheduling and wake up to a calendar full of
            qualified meetings.
          </p>
